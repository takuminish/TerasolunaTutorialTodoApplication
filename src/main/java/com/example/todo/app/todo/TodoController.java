...
public class TodoController {
	...
	public String create(@Validated({Default.class, TodoCreate.class}) TodoForm todoForm, BindingResult bindingResult,
			Model model, RedirectAttributes attriibutes) {
		...
		attriibutes.addFlashAttribute(ResultMessages.success()
	...
	@PostMapping("finish")
	public String finish(@Validated({Default.class, TodoFinish.class}) TodoForm todoForm,
